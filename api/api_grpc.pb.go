...
func (c *catalogIfaceClient) CountryGetByName(ctx context.Context, in *CountryByNameRequest, opts ...grpc.CallOption) (*CountryGetResponse, error) {
	out := new(CountryGetResponse)
	err := c.cc.Invoke(ctx, "/catalog.api.catalog_iface/CountryGetByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCatalogIfaceServer) CountryGetByName(context.Context, *CountryByNameRequest) (*CountryGetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CountryGetByName not implemented")
}
...
func _CatalogIface_CountryGetByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CountryByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogIfaceServer).CountryGetByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog.api.catalog_iface/CountryGetByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogIfaceServer).CountryGetByName(ctx, req.(*CountryByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CatalogIface_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CountryGetByName",
			Handler:    _CatalogIface_CountryGetByName_Handler,
		},
		{
			MethodName: "UnitOfMeasureCreate",
